...
CLAUDE.md accuracy is verified during each release (see [60-release.md](../process/60-release.md) Phase 1: Pre-flight). This ensures documentation doesn't drift too far from reality.
