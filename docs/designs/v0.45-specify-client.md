...
**Sprint:** #162 (v0.45 Specify Client + Integration)
**Release:** #153
...
1. **Should `spec get` auto-retry on transient failures?**
   - Proposal: No for v0.45, add `--retry N` in future if needed
...
- [v0.45-specify-server.md](v0.45-specify-server.md) - Server design (Sprint #161)
