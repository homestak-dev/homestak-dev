...
- **User-owned path model**: Update `validate.sh` stage-mode commands to remove `sudo`; update CLAUDE.md installation paths from FHS to user-owned model (bootstrap#75)
